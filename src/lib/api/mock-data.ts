...
export const MOCK_COUPONS: CouponRecord[] = [
  {
    id: "cp-001",
    code: "YAZ2025",
    description: "Yaz indirimi - tum planlarda %20 indirim",
  ...
  },
  {
    id: "cp-002",
    code: "STUDIO500",
    description: "Studio planina ozel 500₺ indirim",
    discountType: "fixed",
    discountValue: 500,
  ...
  },
  {
    id: "cp-003",
    code: "ESKIYIL2024",
    description: "2024 yil sonu kampanyasi - sureti dolmus ornek",
    discountType: "percent",
    discountValue: 15,
    discountDurationMonths: 12,
    maxUses: 200,
...
export const MOCK_COUPON_REDEMPTIONS: CouponRedemptionRecord[] = [
  ...
  },
  {
    ...
    redeemedAt: "2025-07-10T09:15:00Z",
  },
  {
    id: "cr-003",
    code: "YAZ2025",
    ...
    displayName: null,
    redeemedAt: "2025-06-28T16:45:00Z",
  },
  {
    id: "cr-004",
    code: "ESKIYIL2024",
    ...
    redeemedAt: "2024-12-20T11:00:00Z",
  },
];
